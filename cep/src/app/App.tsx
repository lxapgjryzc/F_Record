...
import { refreshCssVariables } from "./cssVars";
...
export function App(): JSX.Element {
    ...
    useEffect(() => {
        ...
        const applyTheme = () => {
            ...
            // Chromium 41 has no var(): the palette is substituted into the
            // stylesheet by hand there, and has to be again for the new class.
            refreshCssVariables();
        };
        applyTheme();
