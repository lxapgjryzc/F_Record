...
// The encoder alone, not the package entry: that would pull in the decoder,
// which is never used and is the one file in jpeg-js written past ES5 --
// which the Node 4 hosts of CC 2015.5..CC 2018 cannot parse.
